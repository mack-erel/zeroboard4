...
<table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#b0b0b0>
	<tr height=30>
		<td bgcolor=#3d3d3d colspan=2><img src=images/admin_deletegroup.gif> </td> </tr> <tr height=1>
	...
	<form name=write method=post action=<?= $_SERVER["PHP_SELF"] ?> enctype=multipart/form-data onsubmit="return confirm('삭제하시겠습니까?')">
		...
		<tr align=center>
			<td bgcolor=bbbbbb colspan=2 height=25 style=font-family:Tahoma;font-size:8pt;>Group Name : <b><?= $data["name"] ?></b></td>
		</tr>
		<tr align=center>
		...
		<tr align=right>
			<td width=47% style=font-family:Tahoma;font-size:8pt;><br>회원들을 이동시킬 그룹 지정 : &nbsp;</font>
			</td>
