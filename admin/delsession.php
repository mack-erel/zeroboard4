	...
	<form name=sdc action=<?= $_SERVER["PHP_SELF"] ?> method=post>
		...
		<table border=0 cellspacing=1 cellpadding=4 width=300 bgcolor=bbbbbb>
			...
			<tr bgcolor=white>
				...
				<td><input type=input name=num value="" size=30 style=border:0;height:18px></td>
			</tr>
			<tr bgcolor=white>
				<td align=center>용량</td>
				<td><input type=input name=size value="" size=30 style=border:0;height:18px></td>
			</tr>
			<tr bgcolor=cccccc>
