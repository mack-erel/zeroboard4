		...
		<tr>
			<td valign=top>
				<table border=0 width=100%>
					...
					<tr>
						<td nowrap>
							<font color=white size=4 face=tahoma><b>Zeroboard & DreamWiz 검색서버 추가</b></font>
						</td>
					</tr>
				</table>
				<br>
				...
				<table border=0 cellspacing=1 cellpadding=0 width=98% bgcolor=#000000>
					<tr>
						<td bgcolor=#FFFFFF>
							<table border=0 width=100%>
								<col width=120 align=right style='padding-right:10px;color:#AAAAAA;font-weight:bold'>
								</col>
								<col>
								</col>
								<tr>
