...
<table border=0 cellspacing=1 cellpadding=3 width=100% bgcolor=#b0b0b0>
	<tr height=30>
		<td bgcolor=#3d3d3d colspan=5><img src=images/admin_webboard.gif> </td> </tr> <Tr height=30>
	...
	<tr height=1>
		<td bgcolor=#000000 style=padding:0px; colspan=5><img src=images/t.gif height=1></td>
	</tr>
			...
			<tr height=23 align=center bgcolor=#e0e0e0>
				...
				<td style=font-family:Tahoma;font-size:8pt>
					...
					if (!$total_num && $total_category > 1)
						echo "<a href={$_SERVER["PHP_SELF"]}?exec=view_board&no=$no&exec2=del_category&group_no=$group_no&page=$page&page_num=$page_num&category_no={$data["no"]} onclick=\"return confirm('삭제하시겠습니까?')\">Delete</a>";
					else echo "&nbsp;";
					?>
				</td>
			</tr>
				...
				<table border=0 cellpadding=2 cellspacing=0>
					<tr>
						<td style=font-family:Tahoma;font-size:8pt;font-weight:bold;>
							선택된 카테고리의 게시물을 일괄 이동 : </td>
						<td><img src=images/t.gif height=2><br><select name=movename class=input>
								<?php
						...
						<td>
							<input type=submit value=' 이동 ' style=border-color:#b0b0b0;background-color:#3d3d3d;color:#ffffff;font-size:8pt;font-family:Tahoma;height:20px;> </td>
					</tr>
				</table>
			</td>
	</form>
...
<form method=post action=<?= $_SERVER["PHP_SELF"] ?>>
	...
	<table border=0 cellpadding=2 cellspacing=0>
		<tr>
			<td style=font-size:8pt;font-family:Tahoma;color:#ffffff;font-weight:bold>
				카테고리 추가</td>
