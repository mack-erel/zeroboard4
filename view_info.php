		...
		<td>
			<table border=0 width=100% cellspacing=0 cellpadding=3>
				<form method=post action=send_message.php name=write>
					...
					?>
						<tr>
							<td align=right><img src=images/memo_id.gif> </td> <td valign=bottom>&nbsp;<font color=brown><b><?= del_html($data["user_id"]) ?> (<?= $data["name"] ?>)</td>
						</tr>
					<?php
					} else {
					?>
						...
						?>
							...
							<tr>
								<td align=right><img src=images/memo_id.gif> </td> <td valign=bottom>&nbsp;<font color=brown><b><?= $data["user_id"] ?> (<?= $data["name"] ?>)</td>
							</tr>
						<?php } ?>


						<tr>
							<td align=right><img src=images/sm_from.gif> </td> <td>&nbsp;<input type=text name=from size=20 maxlength=20 class=input style=border-color:#d8b3b3></td>
						</tr>
						<tr>
							<Td align=right><img src=images/vi_email.gif> </td> <td>&nbsp;<input type=text name=email size=40 maxlength=80 class=input style=border-color:#d8b3b3></td>
						</tr>
					<?php
					}
					?>
					<tr>
						<td width=50 align=right><img src=images/vi_subject.gif> </td> <td>&nbsp;<input type=text style=width:80% name=subject class=input style=border-color:#d8b3b3> <input type=hidden name=html value=0></td>
					</tr>
					<tr>
