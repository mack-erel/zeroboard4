...
if ($mode == "modify" && $no) {
	...
	// 파일등록
	if ($file_name1) {
		$del_que1 = ",file_name1='$file_name1',s_file_name1='$s_file_name1'";
	}
	if ($file_name2) {
		$del_que2 = ",file_name2='$file_name2',s_file_name2='$s_file_name2'";
	}
	...
	if (!$notice && $s_data["headnum"] <= "-2000000000") {
		...
		if ($prev_data[0]) $prev_no = $prev_data[0];
		else $prev_no = 0;
