...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td background="images/memo_topbg.gif">
			...
			<font style=font-size:11pt;font-weight:bold>&nbsp;쪽지보내기</font>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	<tr>
		...
		<td align=right>
			<font color="#666666">전체회원수 : <?= $total ?></font>&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
</table>
			...
			<table border=0 cellspacing=0 cellpadding=0 width=100%>
				<form method=post action=<?= $_SERVER["PHP_SELF"] ?> name=list onsubmit="return check_status()">
					...
					<tr align=center height=15>
						<td width=35%><img src=images/memo_level.gif> </td> <td width=25%><img src=images/memo_id.gif> </td> <td width=25%><img src=images/memo_name.gif> </td> <?php if ($status) { ?><td width=15%><img src=images/memo_status.gif> </td><?php } ?> </tr> <?php
																																																																			// 출력
