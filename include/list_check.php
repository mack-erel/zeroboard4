...
function list_check(&$data, $view_check = 0)
{
	...
	if ($setup["use_alllist"]) $view_file = "zboard.php";
	else $view_file = "view.php";
	// 제목에 링크 거는 부분;
	...
	if ($prev_no == $data["no"]) $number = "<img src=$dir/arrow.gif border=0 align=absmiddle>";
	elseif ($number != "&nbsp;") $number = $loop_number;
