...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td background="images/memo_topbg.gif">
			...
			<font style=font-size:11pt;font-weight:bold>&nbsp;받은쪽지함</font>
		</td>
	...
	<tr>
		...
		<td align=right><img src="images/t.gif" width="10" height="10">
			<font color="#666666">전체 :
				<b><?= $total ?></b> , 새 쪽지 : <b><?= $new_total ?></b></font>&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3">
					<tr>
						...
						<td><img src="images/t.gif" width="10" height="3"><br>
							<a href=javascript:void(window.open('view_info.php?member_no=<?= $now_data["member_from"] ?>','view_info','width=400,height=500,toolbar=no,scrollbars=yes'))><?= stripslashes($now_data["name"]) ?></a>
								...
								?>
									...
									<tr onMouseOver=this.style.backgroundColor="#FFF5F5" onMouseOut=this.style.backgroundColor="">
										...
										<td width="80" align="center"><img src="images/t.gif" width="10" height="3"><br>
											<a href=javascript:void(window.open('view_info.php?member_no=<?= $data["member_from"] ?>','view_info','width=400,height=510,toolbar=no,scrollbars=yes'))><?= $data["name"] ?></a><br>
