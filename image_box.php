	...
	<form method=post action="<?= $_SERVER["PHP_SELF"] ?>" ENCTYPE="multipart/form-data" name=imageList>
		...
		<table border=0 width=98% cellspacing=0 cellpadding=0>
			<tr>
				...
				<td width=100% background=images/im_title_back.gif> <img src=images/im_title_back.gif> </td> <td align=right onmouseover=zbHelp.style.visibility='visible'><img src=images/im_title_right.gif border=0></td>
			</tr>
		</table>
		<table border=0 width=98% cellspacing=0 cellpadding=5>
			<tr>
				...
				<td align=right>
					<font color=444444 style=font-family:tahoma;font-size:7pt><b><?= $image_page ?>/<?= $total_page ?> Pages
				</td>
			</tr>
		</table>
		<br>
		...
		<div id='inputTable' style='position:absolute; left:50px; top:120px; width:500px; height: 250; z-index:1; visibility: hidden'>
			...
			<table border=0 width=95% bgcolor=888888 height=3 cellspacing=0 cellpadding=0>
				<tr>
					<td></td>
				<tr>
			</table>
					...
					<table border=0 cellspacing=1 cellpadding=2 width=100% height=100% bgcolor=666666>
						...
						<tr>
							<td bgcolor=eeeeee height=20 align=center>
								...
								<a href="javascript:void(window.open('<?= $path ?>/<?= $image_list[$i] ?>','imageBoxViewer','width=<?= $size[0] + 20 ?>,height=<?= $size[1] + 40 ?>,toolbars=no'))">
									<font color=555555 style=font-size:7pt;font-family:verdana>[<b>view</b>]</font>
								</a>
								<a href=<?= $_SERVER["PHP_SELF"] ?>?id=<?= $id ?>&exec=delete&no=<?= $i ?>&image_page=<?= $image_page ?> onclick="return confirm('삭제하시겠습니까?')">
									<font color=555555 style=font-size:7pt;font-family:verdana>[<b>del</b>]</font>
								</a>
