...
// 각 기능별 파일 호출
if ($exec == "view_board") {
	include_once "admin/admin_exec_board.php";
} elseif ($exec == "view_member") {
	include_once "admin/admin_exec_member.php";
} else {
	include_once "admin/admin_exec_group.php";
}
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#000000" height=100%>
				...
				<tr>
					<td valign="top" colspan="2" align=right>
						...
						<?php if ($member["is_admin"] == 1) { ?>
							<a href=admin_setup.php?exec=uninstall>
								<font color=white style=font-size:9pt onclick="return confirm('제로보드를 제거하시겠습니까?')"><b>Uninstall</b></font>
							</a> &nbsp;|&nbsp;
							<a href=admin_setup.php?exec=db_dump>
								<font color=white style=font-size:9pt onclick="return confirm('백업하시겠습니까?')"><b>DB 백업</b></font>
							</a> &nbsp;|&nbsp;
							<a href=admin_setup.php?exec=db_status>
								<font color=white style=font-size:9pt><b>DB 상태 보기</b></font>
							</a> &nbsp;|&nbsp;
							<a href=admin/arrangefile.php target=_blank onclick="return confirm('첨부파일 정리시에는 첨부파일의 종류에 따라서 시간이 오래 걸릴수 있습니다\n\n실행하시겠습니까?')">
								<font color=white style=font-size:9pt><b>첨부파일 정리</b></font>
							</a> &nbsp;|&nbsp;
							<a href=admin/delsession.php target=_blank onclick="return confirm('세션의 양이 많아지면 전체적인 속도가 느려질수 있습니다.\n\n세션 디렉토리를 정리하시겠습니까?')">
								<font color=white style=font-size:9pt><b>세션 비우기</b></font>
							</a> &nbsp;|&nbsp;
							<a href=admin/trace.php target=_blank>
								<font color=white style=font-size:9pt><b>게시물 추적</b></font>
							</a> &nbsp;|&nbsp;
							<a href=http://nzeo.com/manual/index.html target=_blank>
								<font color=white style=font-size:9pt><b>매뉴얼</b></font>
							</a>&nbsp;&nbsp;
						<?php } ?>
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td nowrap style="font-family:Tahoma;font-size:8pt;">
									<font color="#FFFFFF"><b><?= $member["user_id"] ?></b></font>
								</td>
								...
								<td nowrap style="font-family:Tahoma;font-size:8pt;">
									...
									?>
									&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href=logout.php?s_url=admin.php>
										<font color=white style=font-size:9pt><b>Log Out</b></font>
									</a>&nbsp;&nbsp;
								</td>
							</tr>
						</table>
	...
	<tr bgcolor="#FFFFFF">
		...
		<td bgcolor="#3F3F3F" valign="top">
			...
			?>
				<table width=100% border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td bgcolor=#595959><img src=images/l_group.gif> </td> </tr> </table> <?php
					...
					<tr>
						<td height=29 background=images/gnamebg.gif align=center><img src=images/t.gif width=10 height=3><br>
							&nbsp;<a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_group&group_no=<?= $group_data["no"] ?>>
								<font color=white><?= $b . $group_data["name"] ?> (<?= $group_data["no"] ?>)</b></font>
							</a></td>
					</tr>
					...
					?>
						...
						<tr>
							<td bgcolor=#868686 style=font-family:Tahoma;font-size:8pt;padding:3px><img src=images/g_top.gif width=38 height=14><br>
								...
								<img src=images/m_top1.gif width=51 height=14 align=absmiddle><b>
									<font color=#FFFFFF><?= $group_data["member_num"] ?></font>
								</b><img src=images/m_top2.gif width=6 height=14 align=absmiddle><br>
								...
								<img src=images/t.gif width=10 height=5><br>
								<img src=images/w_top1.gif width=58 height=14 align=absmiddle><b>
									<font color=#FFFFFF><?= $group_data["board_num"] ?></font>
								</b><img src=images/w_top2.gif width=4 height=14 align=absmiddle>
								<br>
								<a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_board&group_no=<?= $group_data["no"] ?>&page=<?= $page ?>&page_num=<?= $page_num ?>><img src=images/w_manage.gif alt="게시판 관리" border=0></a><a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_board&exec2=add&group_no=<?= $group_data["no"] ?>><img src=images/w_add.gif alt="게시판 추가" border=0></a>
							</td>
						</tr>
				<?php
																									}
				...
				<table width=100% border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td bgcolor=#595959 align=center><img src=images/l_group.gif> </td> </tr> </table> <table width=100% border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td height=29 background=images/gnamebg.gif align=center><img src=images/t.gif width=10 height=3><br>
							<a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_group&group_no=<?= $group_data["no"] ?>><b>
									<font color=white><?= $b . $group_data["name"] ?> (<?= $group_data["no"] ?>)
								</b></font></a></td>
					</tr>
					...
					?>
						...
						<tr>
							<td bgcolor=#868686 style=font-family:Tahoma;font-size:8pt;padding:3px><img src=images/g_top.gif width=38 height=14><br>
								...
								<a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_member&group_no=<?= $group_data["no"] ?>><img src=images/m_manage.gif width=73 height=12 border=0 alt="회원 관리"></a><a href=<?= $_SERVER["PHP_SELF"] ?>?exec=modify_member_join&group_no=<?= $group_data["no"] ?>><img src=images/m_joinform.gif width=55 height=12 border=0 alt="가입폼설정"></a><br>
								<img src=images/t.gif width=10 height=5><br>
								<img src=images/w_top1.gif width=58 height=14 align=absmiddle><b>
									<font color=#FFFFFF><?= $group_data["board_num"] ?></font>
								</b><img src=images/w_top2.gif width=4 height=14 align=absmiddle>
								<br>
								<a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_board&group_no=<?= $group_data["no"] ?>><img src=images/w_manage.gif width=73 height=12 alt="게시판 관리" border=0></a><a href=<?= $_SERVER["PHP_SELF"] ?>?exec=view_board&exec2=add&group_no=<?= $group_data["no"] ?>><img src=images/w_add.gif width=29 height=12 alt="게시판 추가" border=0></a>
							</td>
						</tr>
		...
		<td width=100% align=center valign=top bgcolor=#3d3d3d>
			...
			if ($member["is_admin"] == 1) {
				if ($exec == "add_group") {
					include_once "admin/admin_add_group.php";
				} elseif ($exec == "uninstall") {
					include_once "admin/admin_uninstall.php";
				} elseif ($exec == "db_status") {
					include_once "admin/admin_dbstatus.php";
				} elseif ($exec == "modify_group") {
					include_once "admin/admin_modify_group.php";
				} elseif ($exec == "view_group") {
					include_once "admin/admin_view_group.php";
				} elseif ($exec == "del_group") {
					include_once "admin/admin_del_group.php";
				} elseif ($exec == "modify_member_join") {
					include_once "admin/admin_modify_member_join.php";
				} elseif ($exec == "view_member") {
					if ($exec2 == "sendmail") {
						include_once "admin/admin_sendmail.php";
					} elseif ($exec2 == "modify") {
						include_once "admin/admin_modify_member.php";
					} else {
						include_once "admin/admin_view_member.php";
					}
				} elseif ($exec == "view_board") {
					if ($exec2 == "add") {
						include_once "admin/admin_add_board.php";
					} elseif ($exec2 == "modify") {
						include_once "admin/admin_modify_board.php";
					} elseif ($exec2 == "category") {
						include_once "admin/admin_category.php";
					} elseif ($exec2 == "modify_category") {
						include_once "admin/admin_category_modify.php";
					} elseif ($exec2 == "grant") {
						include_once "admin/admin_modify_grant.php";
					} else {
						include_once "admin/admin_board_list.php";
					}
				} else {
					include_once "admin/readme.php";
				}

				// 그룹 관리자일 경우
			} elseif ($member["is_admin"] == 2) {
				$group_no = $group_data["no"];
				if ($exec == "modify_group") {
					include_once "admin/admin_modify_group.php";
				} elseif ($exec == "modify_group") {
					include_once "admin/admin_modify_group.php";
				} elseif ($exec == "modify_member_join") {
