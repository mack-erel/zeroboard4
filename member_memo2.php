...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td background="images/memo_topbg.gif">
			...
			<font style=font-size:11pt;font-weight:bold>&nbsp;보낸쪽지함</font>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	<tr>
		...
		<td align=right><img src="images/t.gif" width="10" height="10">
			<font color="#666666">전체 :
				<b><?= $total ?></b> , 읽지 않은 쪽지 : <b><?= $new_total ?></b></font>&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="3">
					<tr>
						...
						<td><img src="images/t.gif" width="10" height="3"><br>
							<a href=javascript:void(window.open('view_info.php?member_no=<?= $now_data["member_to"] ?>','view_info','width=400,height=510,toolbar=no,scrollbars=yes'))><?= stripslashes($now_data["name"]) ?></a>
							<font style=font-size:8pt;>(<b>ID</b> : <?= $now_data['user_id'] ?>)
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><a href=<?= $_SERVER["PHP_SELF"] ?>?exec=del&no=<?= $no ?>&page=<?= $page ?> onclick="return confirm('삭제하시겠습니까?')"><img src="images/memo_delete2.gif" width="31" height="15" border=0></a> <a href=<?= $_SERVER["PHP_SELF"] ?>><img src="images/memo_list.gif" width="18" height="15" border=0></a> </td>
					</tr>
				</table>
			</td>
...
<table border=0 width=100% cellpadding=0 cellspacing=0>
	<tr>
		<form name=list method=post action=<?= $_SERVER["PHP_SELF"] ?> onsubmit="return confirm('삭제하시겠습니까?')">
			...
			<td>
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								while ($data = mysql_fetch_array($result)) {
									...
									if ($data["readed"] == 0) $readed = "<img src=images/memo_readed.gif>";
									else $readed = "<img src=images/memo_unread.gif>"
								?>
									<tr>
									...
									<tr onMouseOver=this.style.backgroundColor="#FFF5F5" onMouseOut=this.style.backgroundColor="">
										...
										<td width="80" align="center"><img src="images/t.gif" width="10" height="3"><br>
											<a href=javascript:void(window.open('view_info.php?member_no=<?= $data["member_to"] ?>','view_info','width=400,height=510,toolbar=no,scrollbars=yes'))><?= $data["name"] ?></a><br>
											<font style=font-size:8pt;color:999999>(<?= $data['user_id'] ?>)
										</td>
										<td width="60" align="center">
											<font style=font-family:Tahoma;font-size:8pt;><span title='<?= $reg_date ?>'><?php echo "" . date("m/d", $data["reg_date"]) . "" ?></span></font>
										</td>
									</tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="5">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;<font style=font-family:Tahoma;font-size:7pt;color:#cc0000><?= $print_page ?></font>
						</td>
